...
export default function PasswordResetSuccess({
  ...
  message = "You're all set! You can now log in with your new password. If you didn't make this change, please reach out to our support team right away so we can help secure your account.",
  buttonText = "Sign In",
  href = "/login",
}: Props) {
  return (
